...
Дашборд позволяет анализировать результаты гонок, пилотов и команд, пит-стопы, лучшие круги и погодные условия.

<!-- После добавления изображения в images раскомментировать:
